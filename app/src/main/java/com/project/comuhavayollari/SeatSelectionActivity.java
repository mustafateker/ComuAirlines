...
public class SeatSelectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedFlight != null) {
        ...
        } else if (roundTripSelectedFlight != null) {
            ...
            Toast.makeText(SeatSelectionActivity.this, "Hiçbir uçuş seçilmedi!", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                if (seat.getStatus() == SeatStatus.SELECTED) {
                    ...
                    checkMemberType(new OnMemberTypeCheckListener() {
                        ...
                        public void memberTypeCheckListener(boolean isVipUye) {
                            ...
                            if (selectedFlight != null) {
                                if (mIsVip) {
                                        selectedFlight.setSeatNumber(finalCurrentSeat);
                                        Toast.makeText(SeatSelectionActivity.this, "Koltuk Seçildi: " + finalCurrentSeat, Toast.LENGTH_SHORT).show();
                                ...
                                if (mIsVip) {
                                        roundTripSelectedFlight.setSeatNumber(finalCurrentSeat);
                                        Toast.makeText(SeatSelectionActivity.this, "Koltuk Seçildi: " + finalCurrentSeat, Toast.LENGTH_SHORT).show();
        ...
        if (!flightId.isEmpty()) {
            ...
            mFlightReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(SeatSelectionActivity.this, "Veri çekme hatası: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
