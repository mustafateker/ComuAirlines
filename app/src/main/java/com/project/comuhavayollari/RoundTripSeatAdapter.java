...
public class RoundTripSeatAdapter extends RecyclerView.Adapter<RoundTripSeatAdapter.SeatViewHolder>{


    private List<Seat> seatList;
    private int selectedPosition = -1;

    public RoundTripSeatAdapter(List<Seat> seatList) {
        this.seatList = seatList;
    }

    @NonNull
    @Override
    public RoundTripSeatAdapter.SeatViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_seat, parent, false);
        return new RoundTripSeatAdapter.SeatViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RoundTripSeatAdapter.SeatViewHolder holder, int position) {
